...
CREATE DATABASE IF NOT EXISTS `viewerlock` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `viewerlock`;
...
-- 테이블 데이터 viewerlock.shape_ref:~4 rows (대략적) 내보내기
INSERT IGNORE INTO `shape_ref` (`model`, `beeline1`, `beeline2`, `shape1`, `shape2`, `cut1`, `cut2`) VALUES
...
INSERT IGNORE INTO `users` (`mail`, `note`) VALUES
